...
public class test{
    public static void main(String[] args){
        ...
        ArrayList <Hand> playerHands = new ArrayList <Hand> (playerCards, playerCards2, playerCards3, playerCards4);
        ...
        for (int i=0; i<4; i++){
                ...
                if(i%2==0){
                    ...
                    playerCards2.addCard(tempCard);
                    playerCards3.addCard(tempCard);
                }
                else{
